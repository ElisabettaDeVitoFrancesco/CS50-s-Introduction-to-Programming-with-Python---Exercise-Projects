...
def date_format():
    ...
    while True:
        try:
            ...
            if "/" in date:
                if int(date.split("/")[0]) >= 1 and int(date.split("/")[0]) <= 12 and int(date.split("/")[1]) >= 1 and int(date.split("/")[1]) <= 31:
                ...
                if date.split(" ")[0] in months_list and int(date.split(" ")[1].split(",")[0]) >= 1 and int(date.split(" ")[1].split(",")[0]) <= 31:
